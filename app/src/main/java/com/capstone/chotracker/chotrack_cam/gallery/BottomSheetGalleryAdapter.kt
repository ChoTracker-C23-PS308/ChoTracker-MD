...
import com.capstone.chotracker.databinding.RecyclerItemDateHeaderBinding
import com.capstone.chotracker.databinding.RecyclerItemMediaBinding
import com.capstone.chotracker.utils.HeaderItemDecoration
import com.capstone.chotracker.utils.getScreenWidth

class BottomSheetGalleryAdapter(private val mMediaList: ArrayList<GalleryModel>, val mInterface: ImageGalleryClickInterface, val mContext: Context):
        ...
        fun bind(position: Int){
            ...
            itemView.setOnClickListener {
                if (imageCount == 0 && !mTapToSelect) {
                    ...
                    mInterface.onImageGalleryLongClick(media, this@BottomSheetGalleryAdapter::class.java.simpleName)
                }else{
